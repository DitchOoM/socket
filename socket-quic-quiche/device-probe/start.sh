...
adbs shell "nohup am instrument -w -e class $PROBE_CLASS -e probeHost $SERVER_HOST -e probePort $SERVER_PORT -e probeMinutes $MIN -e probeEchoIntervalMs $EI $BUDGET_ARG $RUNNER > /dev/null 2>&1 &"
sleep 8
