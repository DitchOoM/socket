...
/**
 * Kotlin/Native (linuxX64) idle-timeout / keepalive test — the K/N member of the shared
 * [QuicIdleTimeoutTestSuite]. Provides linuxX64 cert resolution; native compiles quiche via cinterop,
 * so there is no `UnsatisfiedLinkError` skip path.
 */
