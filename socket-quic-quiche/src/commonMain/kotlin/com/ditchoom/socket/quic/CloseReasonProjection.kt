 ...
 * want "the error, if there was one" — trace recording and the datagram adapter's fallback.
 * [QuicConnectionState.Closed] stores an exhaustive [QuicCloseReason], so the ambiguity this collapses
 * ([QuicCloseReason.Graceful] vs [QuicCloseReason.Unspecified]) is discarded per use site rather than
