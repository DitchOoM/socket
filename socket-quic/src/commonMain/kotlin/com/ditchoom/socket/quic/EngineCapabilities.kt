 ...
 *
 * Lets common code branch on engine capability without reaching for a runtime stub — e.g. check
 * `engine.capabilities.supportsServer` before binding, which is `false` on the tvOS/watchOS/JS
 * [UnsupportedQuicEngine]. The fine-grained per-call
...
data class EngineCapabilities(
    /** Connection migration (RFC 9000 §9) — `true` for quiche. */
