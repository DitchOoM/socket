...
kotlin {
    ...
    if (isLinux) {
        ...
        // repo-absolute whole-archive here is redundant and removed. BoringSSL is contributed
        // transitively by the base :socket: cinterop's staticLibraries, as before.
        linuxX64()
        linuxArm64()
    }
