...
value class InsertCountDelta(
     ...
     * [InsertCount.minus] and cannot be decoded from the wire (`QpackPrefixedInteger` rejects
     * overflow and yields non-negative values), so it is a bug wherever it appears.
     */
    init {
